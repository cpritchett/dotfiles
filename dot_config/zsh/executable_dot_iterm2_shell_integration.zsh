...
if [[ -o interactive ]]; then
  if [ "${ITERM_ENABLE_SHELL_INTEGRATION_WITH_TMUX-}""  if [ "${ITERM_ENABLE_SHELL_INTEGRATION_WLE  if [ "${ITERM_ENAWI  if [ "${ITERM_ENABLEsc  if [ "${ITERM_ENABLE_SHELL_INTEGRATION_WLE  if [ "${ITERM_ENA"   if [ "${ITERM_ENABLE_SHELL_INTEGRATION_WITH_TMUX-}""  if [ "${ITERM_ENABLes  if [ "${ITERM_ENABLE_SHELL_INTEGRATION_WITH_TMUX-}""  if [ "f   if [ "${ITERM_ENABLE_SHELL_INTEGRATION_WITH_TMUX-}""  if [2_  if [ "${ITERM_ENABLE_SHELL_INTEGRATION_WITH_TMUX-}""  if [ "$"   if [ "${ITERM_ENABLE_SHELL_INTEGRATION_WITH_TMUX-}""        if [ "${ITERM_ENABLE_SHELL_INTEGRATION_WITH_TMUX-}""  if [ "${ar  if [ "${ITERM_ENABLE_SHELL_INTEGRATION_WITH_TMUX-}""  if [ "$f   if [ "${ITERM_ENABLE_SHELL_INTEGRATION_WITH_TMUX-}""  if [ "th  if [ "${ITERM_ENABLE_SHELL_INTEGRATION_WITHl
                                                                     .,                                                            in iTerm2 (in a badge now, elsewhere in the future) as
